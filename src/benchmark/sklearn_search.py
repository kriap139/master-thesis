...
class SklearnSearch(BaseSearch):
    def __init__(self, model, train_data: Dataset, test_data: Dataset = None,
                 n_iter=100, n_jobs=None, cv: TY_CV = None, inner_cv: TY_CV = None, scoring = None, save=False, save_inner_history=True, verbose=2, max_outer_iter: int = None, refit=True, add_save_dir_info: dict = None):
