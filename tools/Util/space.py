# From: https://github.com/scikit-optimize/scikit-optimize/blob/de32b5fd2205a1e58526f3cacd0422a26d315d0f/skopt/space/transformers.py
# Had to fix a bug where the sampled value returned as an array istead of an Integer, to be able to make it work with sklearn estimators
import numbers
import numpy as np
import yaml
...
class Dimension(object):
    ...
    def rvs(self, n_samples=1, random_state=None):
        ...
        transformed = self.inverse_transform(samples)

        return transformed[0] if n_samples == 1 else transformed
